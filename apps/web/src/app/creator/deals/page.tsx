...
/* ------------------------------------------------------------------ */
/*  Status badge colors (re-declared for detail section)               */
/* ------------------------------------------------------------------ */
  ...
  return (
    <div className="rounded-card bg-surface-50 p-4">
      ...
      <div className="space-y-3">
        <div>
          <p className="mb-1 text-xs font-medium text-gray-500">Brand Review</p>
    ...
    <div className="flex h-full flex-col overflow-hidden rounded-card bg-white shadow-card">
      ...
      <div className="flex items-center justify-between border-b border-gray-100 px-5 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500">{deal.brandName}</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-5 py-4">
          ...
          <div className="mb-5">
            {deal.status === "negotiating" && (
              <div className="mb-2 flex gap-2">
                <button className="flex-1 rounded-button bg-green-500 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-green-600">
                  Accept Terms
                </button>
                <button className="flex-1 rounded-button border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-50">
                  Counter
                </button>
              </div>
            )}
        ...
        <div>
          ...
          <MessageThread messages={deal.messages} currentUserType="creator" />
        </div>
      </div>
    </div>
  );
